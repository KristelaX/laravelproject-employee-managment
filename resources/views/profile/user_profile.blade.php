    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('profile.update', ['profile'=>$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <img src="storage/images/{{$user->picture}}" width="200px" height="200px">
                            </div>
                            <div class="col-md-4"></div>
                        </div>
                        <br><br>
               ...
               <input type="hidden" value="{{ old($user->password) }}" id="hidd_pas" name="hidd_pas">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="adresa" type="text" class="form-control{{ $errors->has('adresa') ? ' is-invalid' : '' }}" name="adresa" value="{{ $user->adresa }}" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="statusi" class="col-md-4 col-form-label text-md-right">{{ __('Statusi') }}</label>

                            <div class="col-md-6">
                                <input id="status" type="text" class="form-control"  name="status" value="Punonjes" />
