    ...
    $.extend(TreeGrid.prototype, {
        fnConstruct: function (oInit) {
            ...
            dataTable.on('click', 'td.treegrid-control', function (e) {
                ...
                var row = dataTable.row($(e.currentTarget).parent("tr"));
                var index = row.index();
                var data = row.data();
                ...
                if( $.isFunction(registerDtRowClickEvents) )
                    registerDtRowClickEvents();
            });
            ...
            dataTable.on('click', 'td.treegrid-control-open', function (e) {
                ...
                var index = dataTable.row($(e.currentTarget).parent("tr")).index();
